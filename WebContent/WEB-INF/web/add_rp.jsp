...
<body onload="isFlag()">
	...
	<div class="leftbar">
		<ul class="list-group" style="width:200px;">
			...
			<a href="/teacher/admin/changRPAction" class="list-group-item active" id="reward" >
	...
	<div class="rightbar">
		<ol class="breadcrumb">
			...
			<li><a href="/teacher/admin/changRPAction">奖惩信息</a></li>
			<li class="active">奖惩信息修改</li>
		</ol>
		<table class="table table-bordered table-hover table-striped table-condensed">
			<thead>
			<tr>
				<td>类型</td><td>金额</td><td colspan="3">原因</td><td>日期</td>
			</tr>
			</thead>
			<form action="/teacher/admin/addRPAction" >
			<tbody id="rp_form">
				<tr>
				<input type="hidden" name="uid"  value="${tid}"/>
				<td><select name="reward"><option value="1">奖励</option><option value="0">罚款</option></select></td>
				<td><input name="money" type="number"/></td>
				<td colspan="3"><input name="content" type="text"/></td>
				<td><input name="time" type="date" /></td>
				</tr>
			</tbody>
			<tbody>
				<tr><td colspan="6"><input onclick= "return confirm('确定修改?');" class="btn btn-info" type="submit" value="确定修改"></td></tr>
			</tbody>
			</form>
		</table>
