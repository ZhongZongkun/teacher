...
<body onload="isFlag()">
	...
	<div class="leftbar">
		<ul class="list-group" style="width:200px;">
			...
			<a href="/teacher/web/showLoginInfoAction" class="list-group-item active">
	...
	<div class="rightbar">
		<ol class="breadcrumb">
			...
			<li class="active">登录详情</li>
		</ol>
		<table class="table table-bordered table-hover table-striped table-condensed">
			<thead>
				<tr><td>序号</td><td>登录IP</td><td>登录时间</td></tr>
			</thead>
			<tbody>
				<s:iterator value="#request.logininfo" status="index">
				<tr>
